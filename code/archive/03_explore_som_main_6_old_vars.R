...
load('./data/som_4x4_main_6_vars_rev.rdata') 
...
ros_events <- ros_subset[, c(2:16, 18)]#change this to match number of variables
...
write.csv(ros_subset[,-1], file = 'ros_som_6_old_groups.csv')
...
vars_to_plot <- unique(to_plot_groups$variable)[c(1, 2, 4, 6, 7, 10, 12, 14, 15)]
...
levels(to_plot_groups$variable) <- 
  c("P", "T", "C", "SWE", "Snowmelt", "Water balance", 
    "Qmax", "RCA", "SCA")
...
ggsave('./results/plots/01_nodes_main_6_old_vars_boxplot_10_Qtypes_rev.png', g1, 'png', 
...
dev.copy(png, './results/plots/01_nodes_main_6_old_vars_radar.png', 
...
ggsave('./results/plots/01_nodes_month_main_6_old_vars.pdf', g2, 'pdf', 
...
ggsave('./results/plots/01_nodes_Qgroupmain_6_old_vars.pdf', g3, 'pdf', 
       width = 30, height = 20, units = 'cm')
