...
load('./data/som_4x4_main_4_vars_rev.rdata') 
...
vars_to_plot <- unique(to_plot_groups$variable)[c(1:4, 7, 10, 12, 14, 15)]
...
ggsave('./results/plots/01_nodes_main_4_vars_boxplot_10_Qtypes_rev.png', g1, 'png', 
...
dev.copy(png, './results/plots/01_nodes_main_4_vars_radar.png', 
