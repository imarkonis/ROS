...
ros_subset <- ros[, .(ID,
                      ...
                      Qmax_time_norm2,        #when the Qmax was reached normalized
...
save(ros_som, ros_subset, ros_cat, my_palette, n_var, n_nodes, ros, file = './data/som_4x4_main_4_vars_rev.rdata')
save(ros_som, ros_subset, ros_cat, my_palette, n_var, n_nodes, ros, file = 'som_4x4_main_4_vars_rev.rdata') #Alternative path
