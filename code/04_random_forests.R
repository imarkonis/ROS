...
heatmap(cor(ros_events))
iterations <- rep(10000, 1)
...
colnames(ros_subset)
train_data_maxQ <- ros_subset[1:train_size, c(2:3, 5, 7:10, 13:16)] 
validation_data_maxQ <- ros_subset[(train_size + 1):data_size, c(2:3, 5, 7, 9:10, 13:16)]
